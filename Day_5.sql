...
--Sehirlerden odenen ucret 4500’den fazla olanlari ve 
--personelden ucreti 5000’den az olanlari bir tabloda maas miktarina gore sirali olarak gosteren sorguyu yaziniz
SELECT sehir,maas FROM personel5 WHERE maas>4500
UNION
...
SELECT id,sehir,maas FROM personel6 WHERE id=123456789
UNION
SELECT id,tel,cocuk_sayisi FROM personel_bilgi WHERE id=123456789

-- Personel tablosunda maasi 5000'den az olan tum sehirleri ve maasları bulunuz
...
--Maasi 4800’den az olanlar veya 5000’den cok olanlarin id’lerinilisteleyin
--Personel_bilgi tablosundan 2 veya 3 cocugu olanlarin id lerini yazdirin
...
--5000'den az maas alip Honda'da calismayanlar yazdirin
